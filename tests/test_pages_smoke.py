...
def test_apercu_paysage_utilise_toute_la_largeur(
    page, fabrique_video, rendre_page, poids_apercu
):
...
@pytest.mark.parametrize("page", PAGES)
def test_apercu_portrait_reste_etroit(page, fabrique_video, rendre_page, poids_apercu):
    ...
    """
    at = rendre_page(page, uploaded_video=fabrique_video(720, 1280))
    assert not at.exception
